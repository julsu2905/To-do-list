...
const loginModalForm = document.querySelector(".login-form");
...
const loginModalForm = $('.login-form');
...
if (loginModalForm) {
	loginModalForm.on("submit", (e) => {
		e.preventDefault();
		const email = $('input[type="username"]').val();
...
jQuery(function ($) {
	...
	$(".createProject").on("submit", (e) => {
		e.preventDefault();
		const name = $("input[name *='projectName']").val();
		const des = $("input[name *='description']").val();
		const memQuantity = $("input[name *='memberQuantity']").val();
