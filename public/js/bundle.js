...
})(
	{
		...
		mnjM: [
			function (require, module, exports) {
				...
				var s = function (r, n) {
					(0, e.default)({
						method: "POST",
						url: "http://127.0.0.1:9696/api/login",
						data: { email: r, password: n },
					})
						.then(function (e) {
							"success" === e.data.status &&
								((0, t.showAlert)("success", "Logged in successfully"),
								window.setTimeout(function () {
									location.assign("/home");
								}, 1500));
						})
						.catch(function (e) {
							(0, t.showAlert)("error", e.response.data.message);
						});
				};
				exports.login = s;
				var u = (function () {
										...
										switch ((r.prev = r.next)) {
											case 0:
												return (
													...
													(a =
														"password" === s
															? "http://127.0.0.1:3000/api/v1/userAdmins/updateMyPassword"
															: "http://127.0.0.1:3000/api/v1/userAdmins/updateMe"),
													(r.next = 4),
		...
		FkWg: [
			function (require, module, exports) {
				...
				var r = function (t) {
					(0, e.default)({
						method: "POST",
						url: "http://127.0.0.1:9696/api/users",
						data: t,
					})
						.then(function (e) {
							"success" === e.data.status &&
								((0, s.showAlert)("success", "Sign up successfully"),
								window.setTimeout(function () {
									location.assign("/login");
								}, 1500));
						})
						.catch(function (e) {
							(0, s.showAlert)("error", e.response.data.message);
						});
				};
				exports.addUser = r;
			},
		...
		OFV2: [
			function (require, module, exports) {
				...
				var s = function (r) {
					(0, e.default)({
						method: "POST",
						url: "http://127.0.0.1:9696/api/projects",
						data: r,
					})
						.then(function (e) {
							"success" === e.data.status &&
								((0, t.showAlert)("success", "Create successfully"),
								window.setTimeout(function () {
									location.assign("/project/" + e.data.projectName);
								}, 1500));
						})
						.catch(function (e) {
							(0, t.showAlert)("error", e.response.data.message);
		...
		n38q: [
			function (require, module, exports) {
				...
				var r = function (s, r) {
					var o = "http://127.0.0.1:9696/api/projects/".concat(r);
					(0, e.default)({ method: "PATCH", url: o, data: { name: s } })
						.then(function (e) {
							"success" === e.data.status &&
								((0, t.showAlert)("success", "Added succesfully!"),
								window.setTimeout(function () {
									location.assign("/project/".concat(r));
								}, 1500));
						})
						.catch(function (e) {
							(0, t.showAlert)("error", e.response.data.message);
		...
		Focm: [
			function (require, module, exports) {
				...
				function t(e, r, s, o, u, t, i) {
					...
					d.done ? r(c) : Promise.resolve(c).then(o, u);
				}
				function i(e) {
					return function () {
						var r = this,
				...
				var d = document.querySelector(".form-login"),
					c = document.querySelector(".logout"),
					n = document.querySelector(".form-admin-data"),
					l = document.querySelector(".form-admin-password"),
					m = document.querySelector(".form-signup");
				d &&
					d.addEventListener("submit", function (r) {
						r.preventDefault(), console.log("alo");
						var s = document.querySelector("#email"),
							o = document.querySelector("#password");
						(0, e.login)(s.value, o.value);
					}),
					...
					n &&
						n.addEventListener("submit", function (e) {
							e.preventDefault();
							var s = new FormData();
							s.append("username", document.getElementById("username").value),
												...
												switch ((e.prev = e.next)) {
													case 0:
														return (
															...
															(o = document.getElementById("passwordCurrent")
																.value),
															(u = document.getElementById("password").value),
															(t = document.getElementById("passwordConfirm")
																.value),
															(e.next = 7),
															(0, r.updateSettings)(
																{
					...
					m &&
						m.addEventListener("submit", function (e) {
							...
							console.log(r),
								console.log(o),
								console.log(u),
								(0, s.addUser)({ email: r, password: o, passwordConfirm: u });
						});
				var a = document.querySelector(".add-member");
				a &&
					a.addEventListener("submit", function (e) {
						var r = new RegExp(/\/\w+$/).exec(window.location.href)[0],
							s = $("#username").val();
						console.log({ name: s, projectName: r }),
							(0, u.addMember)(s, r),
							e.preventDefault();
					}),
					jQuery(function (e) {
						e(".sidebar-dropdown > a").click(function () {
							e(".sidebar-submenu").slideUp(200),
								e(this).parent().hasClass("active")
									? (e(".sidebar-dropdown").removeClass("active"),
									  e(this).parent().removeClass("active"))
									: (e(".sidebar-dropdown").removeClass("active"),
									  e(this).next(".sidebar-submenu").slideDown(200),
									  e(this).parent().addClass("active"));
						}),
							e("#close-sidebar").click(function () {
								e(".page-wrapper").removeClass("toggled");
							}),
							e("#show-sidebar").click(function () {
								e(".page-wrapper").addClass("toggled");
							});
					});
			},
			{
